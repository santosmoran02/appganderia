  ...
  return (
    <div className="app-layout">
      ...
      <header className="mobile-header">
        ...
        <span className="mobile-logo-text">GanadApp</span>
      </header>
      ...
      <aside className={`sidebar ${sidebarOpen ? 'sidebar--open' : ''}`}>
        ...
        <nav className="sidebar-nav">
          ...
          <NavLink to="/animales" className={navClass} onClick={closeSidebar}>
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>
            Animales
          </NavLink>
          <NavLink to="/calendario" className={navClass} onClick={closeSidebar}>
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg>
            Calendario
          </NavLink>
          <NavLink to="/recuentos" className={navClass} onClick={closeSidebar}>
          ...
          {granjas.length === 0 ? (
            ...
            granjas.map(g => (
              <NavLink key={g.id} to={`/granjas/${g.id}`} className={({ isActive }) => isActive ? 'nav-item nav-subitem active' : 'nav-item nav-subitem'} onClick={closeSidebar}>
