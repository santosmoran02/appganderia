      ...
      <form className="form-card animal-form-grid" onSubmit={handleSubmit}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 20 }}>
              <div>
                ...
                <div className="form-group" style={{ marginBottom: 10 }}>
                  ...
                  <input type="text" value={form.madre_crotal} onChange={e => set('madre_crotal', e.target.value)} placeholder="Opcional" />
                </div>
                <div className="form-group">
                  <label style={{ color: 'var(--gray-500)' }}>Nombre</label>
                  <input type="text" value={form.madre_nombre} onChange={e => set('madre_nombre', e.target.value)} placeholder="Opcional" />
                </div>
              </div>
              <div>
                ...
                <div className="form-group" style={{ marginBottom: 10 }}>
                  <label style={{ color: 'var(--gray-500)' }}>Crotal</label>
                  <input type="text" value={form.padre_crotal} onChange={e => set('padre_crotal', e.target.value)} placeholder="Opcional" />
                </div>
                <div className="form-group">
                  <label style={{ color: 'var(--gray-500)' }}>Nombre</label>
                  <input type="text" value={form.padre_nombre} onChange={e => set('padre_nombre', e.target.value)} placeholder="Opcional" />
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="animal-form-col-right">
          ...
          <textarea
            ...
            placeholder="Cualquier observación relevante sobre el animal..."
